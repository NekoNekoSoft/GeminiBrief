...
async def main():
    ...
    * **[대응 전략]:** 현재 홀딩/매수/매도 중 유효한 포지션은?

    **3. 🌍 그 외 놓치면 안 될 소식 (Trending)**
    * **[핫한 종목/이슈]:** (예: 테슬라 로봇 발표, 엔비디아 실적 등 내 종목은 아니지만 중요한 소식)
    * **[한 줄 평]:** 왜 이 소식을 알아야 하는가?

    **4. 💡 제미나이의 투자 한마디**
    * 전체적인 시장 분위기를 비유(날씨, 스포츠 등)를 들어 쉽게 요약.

    ※ 각 정보의 [출처]를 반드시 명시할 것.
    """
